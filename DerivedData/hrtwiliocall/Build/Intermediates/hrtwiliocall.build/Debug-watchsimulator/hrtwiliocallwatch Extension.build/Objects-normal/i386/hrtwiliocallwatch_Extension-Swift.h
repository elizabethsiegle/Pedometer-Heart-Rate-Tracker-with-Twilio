...
SWIFT_CLASS("_TtC27hrtwiliocallwatch_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC27hrtwiliocallwatch_Extension19InterfaceController")
@interface InterfaceController : WKInterfaceController <HKWorkoutSessionDelegate, WKExtensionDelegate, WCSessionDelegate>
/**
...
@property (nonatomic, readonly, strong) HKUnit * _Nonnull hrUnit;
@property (nonatomic, strong) HKQueryAnchor * _Nonnull anchor;
@property (nonatomic, strong) HKQuery * _Nullable currQuery;
...
SWIFT_CLASS("_TtC27hrtwiliocallwatch_Extension22NotificationController")
