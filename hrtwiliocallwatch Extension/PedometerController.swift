...
class PedometerController: WKInterfaceController {
    ...
    @IBOutlet var numFloorsAsc: WKInterfaceLabel!
    @IBOutlet var floorsDescLbl: WKInterfaceLabel!
    @IBOutlet var numFloorsDesc: WKInterfaceLabel!
    
    @IBOutlet var distLbl: WKInterfaceLabel!
    @IBOutlet var distCount: WKInterfaceLabel!
    ...
    override func awake(withContext context: Any?) {
        ...
        // set text labels
        self.numSteps.setText("-")
        self.numFloorsAsc.setText("-")
        self.numFloorsDesc.setText("-")
        self.distCount.setText("- m.")
        ...
        if CMPedometer.isPaceAvailable() {
            ...
            self.corePedometer.startUpdates(from: startDate, withHandler: { (data:CMPedometerData?, error:NSError?) -> Void in
                ...
                if (error == nil) {
                    ...
                    self.numFloorsAsc.setText("\(data!.floorsAscended!)")
                    self.numFloorsDesc.setText("\(data!.floorsDescended!)")
                    self.distCount.setText("\(rounded)m.")
